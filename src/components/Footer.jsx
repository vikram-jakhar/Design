                    ...
                    <div className='grid grid-cols-1 gap-16 md:grid-cols-2 lg:grid-cols-7 pt-[87px] '>
                        ...
                        <div className='col-span-1 max-w-[130px] px-3'>
                            <ul className='flex flex-col'>
                                <li className='text-white text-[14px] font-roboto font-medium text-nowrap after:w-full after:absolute relative after:left-0 after:right-0 after:bottom-0  after:h-[2px] after:rounded-full after:bg-[#BD7D41] '>ABOUT STORE</li>
                        ...
                        <div className='col-span-1 max-w-[130px] px-3'>
                            <ul className='flex flex-col'>
                                ...
                                <li className='pt-2'><Link className='text-white text-[14px] font-roboto font-normal transition after:duration-500 after:w-0 hover:after:w-full after:absolute relative after:left-0 after:right-0 after:bottom-0  after:h-[2px] after:rounded-full after:bg-[#BD7D41]'>Aleeper Sofas</Link></li>
                                <li className='pt-2'><Link className='text-white text-[14px] font-roboto font-normal  transition after:duration-500 after:w-0 hover:after:w-full after:absolute relative after:left-0 after:right-0 after:bottom-0  after:h-[2px] after:rounded-full after:bg-[#BD7D41]'>Accent Chairs</Link></li>
                                <li className='pt-2'><Link className='text-white text-[14px] font-roboto font-normal  transition after:duration-500 after:w-0 hover:after:w-full after:absolute relative after:left-0 after:right-0 after:bottom-0  after:h-[2px] after:rounded-full after:bg-[#BD7D41]'>Festival Offer</Link></li>
                                <li className='pt-2'><Link className='text-white text-[14px] font-roboto font-normal  transition after:duration-500 after:w-0 hover:after:w-full after:absolute relative after:left-0 after:right-0 after:bottom-0  after:h-[2px] after:rounded-full after:bg-[#BD7D41]'>Log In</Link></li>
                            </ul>
                        </div>
